...
// Enhanced color and icon helpers for that "bombastic" feel
const scoreDetails = {
  green: {
    label: 'Sustainable',
    Icon: Leaf,
            ...
            <div className="text-center">
                {data.imageUrl && (
                    <Image
                        ...
                        width={128}
                        height={128}
                        className="rounded-xl object-contain mx-auto -mt-16 mb-4 border-4 border-slate-700 bg-white shadow-xl"
                    />
                )}
